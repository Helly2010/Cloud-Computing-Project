...
\end{itemize}
\subsubsection*{Approximate Rental Cost Calculation for to-be Infrastructure}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{|p{0.6\textwidth}|p{0.4\textwidth}|}
    ...
    8. Assessment of the Current (to-be) Infrastructure        & Hellyben Shah \newline Heer Vankawala          \\
    \hline
   5. Assessment of Potential Technological Components \newline 
      -  Approximate Rental Cost Calculation for to-be Infrastructure        & Vishwaben Kakadiya \newline Priyanka Vadiwala        \\
    \hline
   4. Client Requirements \newline
   6. Migration to a Private-Cloud Context  \newline
   7. Roadmap  \newline
   9. Operation Considerations                                                & Wladymir Alexander Brborich Herrera          \\
    \hline
    Github Repository Setup \newline
    Report and Presentation Template Setup \newline
    Screencast and Presentation Preparation      & Wladymir Alexander Brborich Herrera   \newline Hellyben Shah \\
    \hline
