...
\newcommand{\what}{Milestone 3: Practical Implementation of Webshop in CSP Platform}
...
\begin{itemize}
    ...
    \item Cloud service integration demonstration
    \item High availability configuration
    \item Practical validation of architectural decisions
\end{itemize}
...
\begin{itemize}
    \item Frontend: React.js with Azure Static Web Apps
    \item Middleware: Spring Boot on Azure Kubernetes Service
    \item Database: Azure SQL Database with Redis Cache
    \item Blob Storage: Azure Blob Storage for product images
\end{itemize}
