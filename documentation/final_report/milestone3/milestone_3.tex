...
\begin{abstract}
    This report presents a summary of all the planning and execution of the LowTech GmbH Cloud Transformation Project hosted at ttps://github.com/Helly2010/Cloud-Computing-Project.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../diagrams/component diagram.drawio.png}
...
Nevertheless, this service can be upgraded to use "enterprise-grade edge" meaning that Azure will automatically cache the website on edge servers making it fast and easy to deliver to clients.
...
This service was used due to its versatility in deploying any type of web application. To avoid extra costs associated with a private image registry,
to handle deploys we are packaging all the code and artifacts in the GitHub runner and publishing to our application.

One of the disadvantages is the price, once we start using more advanced features and more computing, the service scales rapidly in cost.\\
