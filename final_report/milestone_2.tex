...
\end{itemize}
 Key-features of this service are mentioned below.
...
\subsubsection{Virtual Machine Scale Sets: IaaS}
...
\subsubsection{Virtual Machine: IaaS}
\begin{itemize}
    \item \textbf{CRM \& SCM }

    \begin{itemize}
    \item \textbf{Instance:} \textit{Dls v6-series} 
    \item  \textbf{Operating System:} \textit{Ubuntu Linux} 
    \item  \textbf{vCPUs:} \textit{2}
    \item  \textbf{Operating System:} \textit{4 GiB}  
    \end{itemize}
    Total 5 instances of above VM will be deployed under 1 Scale Set for CRM application used by Operations, Sales \& Customer Service and SCM used by Supply Management.

    \item \textbf{QM}
    \begin{itemize}
        \item 1 more instance of VM same as above
    \end{itemize}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{|l|c|c|c|c|}
      ...
      \hline
      Virtual Machine           & Dls v6-series        &  \textasciitilde 31 €                         & 6               &  \textasciitilde 186 €                \\
      \hline
      Storage           &        &                          &              &                \\
      \hline
      Database           &         &                          &               &                \\
